      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={`relative bg-card dark:bg-card-dark rounded-2xl shadow-2xl border border-border dark:border-border-dark w-full ${sizes[size]} max-h-[90vh] overflow-y-auto`}
          >
